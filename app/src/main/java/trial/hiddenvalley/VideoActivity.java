...
public class VideoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewGroup controlsViewGroup = (ViewGroup) findViewById(R.id.fullscreen_content_controls);
        ...
        if (mediaControls == null) {
            mediaControls = new CustomMediaController(this);
            //mediaControls.setAnchorView(findViewById(R.id.mediaController));


            ((ViewGroup)mediaControls.getParent()).removeView(mediaControls);

            controlsViewGroup.addView(mediaControls);

            //mediaControls.setLayoutParams(new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, FrameLayout.LayoutParams.MATCH_PARENT));



            //mediaControls.setAnchorView(mControlsView);
    ...
    private void show() {
        ...
        mediaControls.show(AUTO_HIDE_DELAY_MILLIS);
